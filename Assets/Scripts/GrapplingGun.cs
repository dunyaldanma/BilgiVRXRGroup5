...
public class GrapplingGun : MonoBehaviour
{
    ...
    public float maxDistanceJoint = 0f;
    public float minDistanceJoint = 0f;
    ...
    void StartGrapple()
    {
        ...
        if (Physics.Raycast(gunTip.position, gunTip.forward, out hit, maxDistance, whatIsGrappleable))
        {
            ...
            joint.maxDistance = distanceFromPoint * maxDistanceJoint;
            joint.minDistance = distanceFromPoint * minDistanceJoint;
